...
if ( ! function_exists('form_textarea'))
{
	...
	{
		$defaults = array('name' => (( ! is_array($data)) ? $data : ''),'id' => (( ! is_array($data)) ? $data : ''), 'cols' => '90', 'rows' => '4');
...
if ( ! function_exists('form_number'))
{
	...
	{
		$defaults = array('type' => 'number', 'name' => (( ! is_array($data)) ? $data : ''),'id' => (( ! is_array($data)) ? $data : ''), 'value' => $value);
